	<footer class="pyunkong d-none">
		<div  class="container ">
			<div class="row d-flex justify-content-between align-items-center m-2 p-2" >
				<div class=" text-white text-center">
					<h2 class="en1"><a href="">평강한의원</a> </h2><!-- image or text  -->
						
						<div class="mt-3">사업자 서효석 </div>
						<div> 사업자등록번호 214-96-04326</div> 
						<div>tel.02.518.777 fax.02.581.1570</div>
						<div>주소 서울특별시 서초구 서운로 1길 21(서초동,편강한의원)</div>
						
					</h2>

				</div>
				<div class="text-white">
					<div><a href="">병원소개</a></div>					
					<div><a href="">지점안내</a></div>					
					<div><a href="">비급여수가 안내</a></div>					
				</div>
				<div>
			...
			<div class="copylight">© 편강한의원 all rights reserved.</div>
    ...
    <div class="container">
        ...
        <div class="fcont">
            ...
            <ul class="fmenu">
                ...
                <li><a href="/s_terms/privacy.do">개인정보취급방침</a></li>
    ...
    <form id="quickCounselForm">
        <div class="fbox d-flex align-items-center justify-content-between">
            <h2>빠른상담신청하기</h2>
