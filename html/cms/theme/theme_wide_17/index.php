...
<div class="swiper mySwiper" id="minsukbanner">
    <div class="swiper-wrapper">
      <div class="swiper-slide slide0">
		<div class="position-absolute textContent container text-white top-0 bottom-0 left-0 right-0 d-flex flex-column justify-content-center">
			<h3>편강한의원의 평강탕</h3>
			<p>기침, 천식, 비염</p>
		</div>
	  </div>
