            ...
            <div class="gall_li_wr">
                ...
                <div class="gall_img_area">
	                ...
	                if ($list[$i]['is_notice']) { // 공지사항 ?>
	                    <strong style="width:<?php echo $board['bo_mobile_gallery_width'] ?>px;height:<?php echo $board['bo_mobile_gallery_height'] ?>px" class="sound_only">공지</strong>
	                    <img src="<?php echo G5_THEME_URL.'/skin/board/gallery/img/notice_img.png'.$config['cf_mobile_logo_file'] ?>">
	                <?php
	                } else {
	                    ...
	                    if($thumb['src']) {
	                        ...
	                        $img_content = '<span class="no-img"><i class="fa fa-picture-o" aria-hidden="true"></i></span>';
	                    }
                ...
                <div class="gall_text_href">
                    ...
                    <div class="gall_writer">      
	                    ...
	                    ?>
						<div class="gall_info">
	                    	<span class="sound_only">작성일 </span><span class="date"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></span>
